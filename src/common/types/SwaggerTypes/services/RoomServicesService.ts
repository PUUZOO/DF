...
export class RoomServicesService {
    ...
    /**
     * Get Room Service Types
     * Get room services types. Applicable Public
     * @returns string Successful Response
     * @throws ApiError
     */
    public static getRoomServiceTypesApiV1RoomServicesTypesGet(): CancelablePromise<Array<string>> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/room/services/types',
        });
    }
...
requestBody: RoomServiceCreateRequest,
     ...
     * Get room_service by id. Applicable Public
     * @param roomServiceId 
     * @returns RoomServiceResponse Successful Response
     * @throws ApiError
     */
