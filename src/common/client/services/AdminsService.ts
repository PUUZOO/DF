...
export class AdminsService {
     ...
     * @throws ApiError
     */
    public static getAllAdminsApiV1AdminsGet(): CancelablePromise<Array<AdminResponse>> {
     ...
     * @throws ApiError
     */
    public static changeAdminPwdApiV1AdminsPwdPut(
adminId: string,
...
requestBody: NewPasswordIn,
     ...
     * @throws ApiError
     */
    public static resetAdminPwdApiV1AdminsAdminIdPwdResetGet(
requestBody: UsernameIn,
): CancelablePromise<StatusResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/admins/{admin_id}/pwd/reset',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                422: `Validation Error`,
